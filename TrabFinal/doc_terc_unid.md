...
<p>Primeiramente, na estrutura do html implementamos o cabeçalho, nele especificamos a cor de fundo através de style="background-color:#4A708B". Veja: </p>
...
<p>Em seguida, na primeira parte do corpo da estrutura html, foi criada a região para exibir os cálculoiis das co-ocorrências e os sliders responsáveis pela delimitação da região de interesse, bem como o botão de retorno. Esta região foi criada com id="Informacoes".</p>
...
<p>Em seguida, na segunda parte do corpo da estrutura html, foi criada a região para carregamento da imagem e exibição da região de interesse com id="CarregamentoDaImagem".</p>
